...
@ResponseStatus(code = HttpStatus.NOT_FOUND, reason = "Não foi possivel localizar dados nas entidades basicas do sistema! Entidade TipoTransacao! veja o script esta em src/main/resources!")
